...
const JobCard: React.FC<(typeof jobData)[0]> = ({
  ...
  <div className='bg-white rounded-2xl shadow-lg p-6 flex flex-col justify-between hover:shadow-xl hover:-translate-y-1 transition-all duration-300'>
    ...
    <div className='mt-6'>
      ...
      <button className='w-full mt-4 bg-gradient-to-r from-primary to-amber-500 text-white font-semibold py-3 px-6 rounded-xl shadow-md hover:shadow-lg transition-all'>
        Apply Now
      </button>
    </div>
  </div>
  ...
  return (
    <div className='space-y-6'>
      ...
      <div className='flex flex-wrap items-center gap-4'>
        ...
        <button className='flex items-center gap-2 bg-white px-4 py-2 rounded-xl shadow-sm text-gray-500 hover:bg-amber-50 transition-colors'>
      ...
      <div className='flex justify-center items-center pt-6'>
        <nav className='flex items-center gap-2'>
          <button className='p-2 rounded-lg hover:bg-amber-100 transition-colors'>
            <Icon name='ChevronLeft' size={20} />
          </button>
          <button className='w-10 h-10 rounded-lg bg-primary text-white font-bold transition-colors'>
            1
          </button>
          <button className='w-10 h-10 rounded-lg hover:bg-amber-100 text-gray-600 font-bold transition-colors'>
            2
          </button>
          <button className='w-10 h-10 rounded-lg hover:bg-amber-100 text-gray-600 font-bold transition-colors'>
            3
